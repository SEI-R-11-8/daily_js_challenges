...
function isPalindrome(string) {
  ...
  return reverse.toLowerCase() === newString.toLowerCase();
}
/*-----------------------------------------------------------------
