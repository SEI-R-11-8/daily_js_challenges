...
function intersection(arr1, arr2) {
  ...
  arr1.forEach((val) => {
    ...
    if (index > -1) result.push(a2.splice(index, 1)[0]);
  });
  return result;
}
/*-----------------------------------------------------------------
...
function getNumForIP(bits) {
  let chunks = bits.splice('.').reverse();
  let sum = 0;
