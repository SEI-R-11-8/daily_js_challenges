...
function reverseUpcaseString(string) {
  ...
  for(let i= 0; i < string.length; i++){
    arr = string.charAt(i).toUpperCase()+ arr
  }
  return arr 
}
/*-----------------------------------------------------------------
...
function mumble(string) {
  let arr = ''
  for(let i = 0; i < string.length; i++){
    arr += ((i || '')&& '-')+string.charAt(i).repeat(i+1)
  }
  return arr
}
/*-----------------------------------------------------------------
...
function findHighestPriced(arr) {
  return arr.reduce((highest, object) => object.price > highest.price ? object : highest);
}
/*-----------------------------------------------------------------
...
function primeFactors(n) {
  let emptyArray = [] 
  if(n<2 || !Number.isInteger(n))return emptyArray
...
///// I somewhat understood this one but i can't say i fully get it 
/*-----------------------------------------------------------------
...
function intersection(arr1, arr2) {
  ...
  arr1.forEach(function(e){
    let index = arrayTwo.indexOf(e)
    if (index > -1) arrayOne.push(arrayTwo.splice(index,1)[0])
  })
  return arrayOne
  }
/*-----------------------------------------------------------------
...
function balancedBrackets(string) {
  ...
  for(let i = 0; i < string.length; i++){
    ...
    if('([{'.includes(results)){
      ...
      if(!'() {} []'.includes(array.pop()+results))return false
    }
  }
  return true
}

//// I am still trying to understand this solution 
/*-----------------------------------------------------------------
...
function toCamelCase(string) {
  return string.replace(/[_-]\w/g, function(e){
