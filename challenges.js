...
function isPalindrome(string) {
  if(string.split('').reverse() == string){
    // console.log(string)
    return true
  } else if (string.toLowerCase().split('').reverse().filter( e => e != ' ').join(' ') == string.toLowerCase().split('').filter( e => e != ' ').join('')) { 
    return true
  } else {
    return false
  }
